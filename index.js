...
new p5((p) => {
  ...
  let characterImages = {
    easy: {
      neutral: p.loadImage("img/easy_neutral.png"),
      happy:   p.loadImage("img/easy_happy.png"),
      sad:     p.loadImage("img/easy_sad.png")
    },
    normal: {
      neutral: p.loadImage("img/normal_neutral.png"),
      happy:   p.loadImage("img/normal_happy.png"),
      sad:     p.loadImage("img/normal_sad.png")
    },
    hard: {
      neutral: p.loadImage("img/hard_neutral.png"),
      happy:   p.loadImage("img/hard_happy.png"),
      sad:     p.loadImage("img/hard_sad.png")
    }
  };
